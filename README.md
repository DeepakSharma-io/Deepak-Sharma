...
Experienced Architect with proven delivery in cloud-native and hybrid environments. I specialize in designing and scaling enterprise network infrastructures, executing complex multi-cloud migrations, and implementing Infrastructure as Code (IaC) to eliminate technical debt and drive operational excellence.
...
<table>
  <tr>
    <td align="center" width="25%"><strong>Cloud Networking</strong></td>
    <td align="center" width="25%"><strong>Routing & Switching</strong></td>
    <td align="center" width="25%"><strong>Automation & DevOps</strong></td>
    <td align="center" width="25%"><strong>Network Security</strong></td>
  </tr>
  <tr>
    <td valign="top">
      <ul>
        <li>AWS (VPC, TGW, Lambda, Direct Connect, Route53)</li>
        <li>Azure (VNet, ExpressRoute)</li>
        <li>Multi-Region Hybrid Architecture</li>
      </ul>
    </td>
    <td valign="top">
      <ul>
        <li>Cisco IOS/IOS-XE, Nexus, ASR</li>
        <li>Cisco SD-WAN</li>
        <li>Layer 3 High-Availability (HSRP)</li>
      </ul>
    </td>
    <td valign="top">
      <ul>
...
### 🧰 Tools & Platforms
`Cisco DNA Center` • `Cisco Prime` • `Dynatrace` • `NetBox` • `Men & Mice IPAM` • `SolarWinds NCM`
